[PHYSICAL_FRONT, READ_AND_REACT, BLANKET_COVERAGE, TOUGHNESS].each do |chemistry|
  ...
  PlayerCardChemistry.create(player_card: ed_reed, chemistry: chemistry, tier: 2)
  PlayerCardChemistry.create(player_card: ed_reed, chemistry: PICK_SPECIALIST, tier: 1)
end

[PHYSICAL_FRONT, READ_AND_REACT, BLANKET_COVERAGE, TOUGHNESS].each do |chemistry|
  paul_krause = PlayerCard.create do |card|
  ...
  PlayerCardChemistry.create(player_card: paul_krause, chemistry: chemistry, tier: 2)
  PlayerCardChemistry.create(player_card: paul_krause, chemistry: PICK_SPECIALIST, tier: 1)
end
