calvin_johnson = PlayerCard.create do |card|
  ...
  card.trait_makes_possession_catches = true
...
PlayerCardChemistry.create(player_card: calvin_johnson, chemistry: GO_DEEP, tier: 2)
PlayerCardChemistry.create(player_card: calvin_johnson, chemistry: PLAYMAKER, tier: 1)

deandre_hopkins = PlayerCard.create do |card|
...
PlayerCardChemistry.create(player_card: deandre_hopkins, chemistry: MOVE_THE_STICKS, tier: 2)
PlayerCardChemistry.create(player_card: deandre_hopkins, chemistry: PLAYMAKER, tier: 1)
