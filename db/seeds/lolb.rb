[PHYSICAL_FRONT, READ_AND_REACT, BLANKET_COVERAGE, TOUGHNESS].each do |chemistry|
  willie_mcginest = PlayerCard.create do |card|
  ...
  PlayerCardChemistry.create(player_card: willie_mcginest, chemistry: chemistry, tier: 2)
  PlayerCardChemistry.create(player_card: willie_mcginest, chemistry: SECURE_TACKLER, tier: 1)
end

rickey_jackson = PlayerCard.create do |card|
...
PlayerCardChemistry.create(player_card: rickey_jackson, chemistry: READ_AND_REACT, tier: 2)
PlayerCardChemistry.create(player_card: rickey_jackson, chemistry: SECURE_TACKLER, tier: 1)
