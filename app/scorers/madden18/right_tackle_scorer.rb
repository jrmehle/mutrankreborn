class Madden18::RightTackleScorer < BaseScorer
  def score
    case @style
    when 'balanced'
      (@card.pass_block      * 1.1) +
    ...
    when 'run_blocking'
      ...
      # but impact blocking is also very important as serving up pancakes keeps
      # the linemen in front of the HB and making more crucial blocks. Being a
      # lead blocker or when pulling off the line is also where speed helps
